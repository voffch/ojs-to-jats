...
**URL PDF статьи** не записывается в JATS и нужен только для загрузки PDF-файла вместе с XML в Метафору (при работе в режиме расширения). Если вам это не нужно, можете не заполнять.
