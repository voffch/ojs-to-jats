...
**Название и аннотация** в зависимости от того откуда загружены или скопированы могут содержать html-тэги. Автоматически они не убираются по разным причинам, в частности, чтобы вы видели, в каком виде у вас хранится информация. Вам их нужно убирать вручную, кликнув на соответствующую кнопку.
...
Даже если у вас исключительно одноязычный журнал, в метаданных для второго языка что-нибудь да будет. Во-первых, часть метаданных по определению не имеет языка (DOI, например), а во-вторых я пытался предусмотреть случаи в которых имена или аффилиации некоторых авторов заполнены только на одном языке. Если вам не нужен второй язык, просто не обращайте на это внимание.

В моих формах практически нет семантической валидации. Отчасти это так потому что какая-то валидация есть в Метафоре, а отчасти - потому что если вы очень хотите забивать DOI и ключевые слова в аннотацию, а название статьи - в дату публикации, то я не буду вам мешать. Чистота ваших метаданных в первую очередь на вашей совести.